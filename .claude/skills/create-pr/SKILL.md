---
description: Create a pull request from the current branch to the main branch using the GitHub MCP tools.
user_invocable: true
---
...
- NEVER add a "Co-Authored-By" trailer or any self-referencing attribution (e.g., "Generated by...", "Created with...") to the PR body
