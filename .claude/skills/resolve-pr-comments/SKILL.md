---
description: Fetch all review comments from a pull request, implement the requested fixes, and reply to each comment confirming the resolution.
user_invocable: true
---
...
- NEVER add a "Co-Authored-By" trailer or any self-referencing attribution (e.g., "Generated by...", "Created with...", "AI", "Claude") to commits, PR replies, or any generated text. Write as if the developer authored it directly.
