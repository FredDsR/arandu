...
from arandu.transcription.batch import (
...
class TestWorkerInitialization:
    ...
    def test_init_worker(self, mock_engine: MagicMock) -> None:
        ...
        from arandu.transcription.batch import _init_worker
...
class TestBatchConfig:
    ...
    def test_batch_config_creation(self, tmp_path: Path) -> None:
        ...
        from arandu.transcription.batch import BatchConfig
    ...
    def test_batch_config_from_transcriber_config_none(
        ...
        mock_config = mocker.patch("arandu.transcription.batch.TranscriberConfig")
...
class TestTranscriptionTask:
    ...
    def test_transcription_task_creation(self) -> None:
        ...
        from arandu.transcription.batch import TranscriptionTask
...
class TestEnsureFloat:
    ...
    def test_ensure_float_valid_float(self) -> None:
        ...
        from arandu.transcription.batch import _ensure_float
...
class TestTranscribeSingleFile:
    ...
    @patch("arandu.transcription.batch._worker_engine", None)
    @patch("arandu.transcription.batch.WhisperEngine")
    ...
    def test_transcribe_single_file_audio_success(
        ...
        from arandu.transcription.batch import BatchConfig, TranscriptionTask
    ...
    def test_transcribe_single_file_corrupted_media(
        ...
        from arandu.transcription.batch import BatchConfig, TranscriptionTask
        from arandu.transcription.media import CorruptedMediaError
    ...
    def test_transcribe_single_file_audio_extraction_error(
        ...
        from arandu.transcription.batch import BatchConfig, TranscriptionTask
        from arandu.transcription.media import AudioExtractionError
...
class TestRunBatchTranscription:
    ...
    def setup_versioning(self, tmp_path: Path, mocker: MockerFixture) -> None:
        ...
        mock_rc = mocker.patch("arandu.transcription.batch.ResultsConfig")
        ...
        mock_tc = mocker.patch("arandu.transcription.batch.TranscriberConfig")
        ...
        mocker.patch("arandu.transcription.batch.ProcessPoolExecutor", _ThreadPoolCompat)
    ...
    @patch("arandu.transcription.batch._worker_engine", None)
    @patch("arandu.transcription.batch.transcribe_single_file")
    @patch("arandu.transcription.batch.load_catalog")
    ...
    @patch("arandu.transcription.batch._worker_engine", None)
    @patch("arandu.transcription.batch.CheckpointManager.is_completed", return_value=True)
    @patch("arandu.transcription.batch.transcribe_single_file")
    @patch("arandu.transcription.batch.load_catalog")
    ...
    @patch("arandu.transcription.batch.transcribe_single_file")
    @patch("arandu.transcription.batch.load_catalog")
    @patch("arandu.transcription.batch.mp.cpu_count")
    ...
    @patch("arandu.transcription.batch._worker_engine", None)
    @patch("arandu.transcription.batch.ProcessPoolExecutor")
    @patch("arandu.transcription.batch.load_catalog")
    def test_run_batch_parallel_processing(
        ...
        with patch("arandu.transcription.batch.as_completed") as mock_as_completed:
